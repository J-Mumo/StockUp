...
from app.routers import auth, stocks, alerts, analysis, portfolio, watchlists, dashboard, notes, company_chat, goals, internal
...
# CORS middleware — origins come from settings.cors_origins (env-driven).
app.add_middleware(
    CORSMiddleware,
